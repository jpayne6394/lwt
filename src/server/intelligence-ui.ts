  ...
  return `
    <section class="panel intelligence-panel">
      ...
      <div class="config-grid">
        ...
        ${listBlock("Social listening seeds", socialListeningSeedLabels(settings))}
      </div>
...
function socialListeningSeedLabels(settings: ContentRadarSourceSettings): string[] {
  return (settings.listeningSeeds ?? []).map((seed) => `${seed.topic}: ${seed.audienceQuestion}`);
}
