...
export type ContentRadarSourceSettings = {
  ...
  listeningSeeds?: SocialListeningSeed[];
};

export type SocialListeningSeed = {
  topic: string;
  priority: "high" | "medium" | "low";
  audienceQuestion: string;
  reactionThemes: string[];
  objectionThemes: string[];
  personalExperienceAngles: string[];
  popularStructurePatterns: string[];
  safeBlogAngles: string[];
